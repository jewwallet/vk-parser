...
export declare type WebhookTransportCallback = (req: IncomingMessage, res: ServerResponse, next?: (err?: Error) => unknown) => unknown;
export declare type WebhookTransportKoaCallback = (context: {
    request: {
