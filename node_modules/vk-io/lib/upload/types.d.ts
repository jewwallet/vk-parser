 ...
 */
export declare type UploadSourceValue = NodeJS.ReadableStream | Buffer | string;
...
export declare type UploadNormalizedSourceOptions = IUploadSourceOptions & {
    values: IUploadSourceMedia[];
};
export declare type UploadAllowedSource = IUploadSourceOptions | IUploadSourceMedia;
