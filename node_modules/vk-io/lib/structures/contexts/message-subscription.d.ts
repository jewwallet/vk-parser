...
export declare type MessageSubscriptionContextType = 'message_subscription';
export declare type MessageSubscriptionContextSubType = 'message_allow' | 'message_deny';
export interface IMessageSubscriptionContextPayload {
    user_id: number;
    key: string;
}
export declare type MessageSubscriptionContextOptions<S> = ContextFactoryOptions<IMessageSubscriptionContextPayload, S>;
