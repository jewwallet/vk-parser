...
export declare type MessageFlagsContextType = 'message_flags';
export declare type MessageFlagsContextSubType = 'message_flags_replace' | 'message_flags_add' | 'message_flags_delete';
...
export declare type MessageFlagsContextOptions<S> = ContextFactoryOptions<number[], S>;
