...
export declare type GroupUserContextType = 'group_user';
export declare type GroupUserContextSubType = 'user_block' | 'user_unblock';
...
export declare type GroupUserContextOptions<S> = ContextFactoryOptions<IGroupUserContextPayload, S>;
